    ...
    <div className={styles.container}>
      <Card elevation={8} className={styles.card}>
        ...
        <div style={{ fontSize: '14px', padding: '0px 16px 5px' }}>
          প্যাকেজ টি {packages[packageIndex].time} এর জন্যে নিতে আমাদের <a href="tel:01726952084">01726952084</a> নম্বরে <strong>নিচের যেকোন মাধ্যমে</strong> {packages[packageIndex].money} "Send Money" করুন <br /><br /> Send Money করার পর নিচের মাধ্যম টি সিলেক্ট করে Transaction ID ভেরিফাই করুন
        </div>
        ...
        <div style={{ fontSize: '14px', padding: '0px 16px 5px', textAlign: 'center' }}>
          বি:দ্র: ১ বছর এর প্যাকেজ টি নিলে <strong>Youtube Premium + Bongo</strong> দেওয়া হবে স্টক সীমিত
        </div>
      </Card>
      <Dialog
        open={dialog}
        ...
        <DialogContent>
          <div style={{ fontSize: '15px', padding: '0px 16px 5px' }}>
            প্যাকেজ টি {packages[packageIndex].time} এর জন্যে নিতে আমাদের <a href="tel:01726952084">01726952084</a> নম্বরে <strong>{paymentMethod.nameBn}</strong> এর মাধ্যমে {packages[packageIndex].money}&nbsp;"Send Money" করুন <br /><br /> Send Money করার পর নিচে Transaction ID দিয়ে SUBMIT বার্টুনে ক্লিক করুন
          </div>
