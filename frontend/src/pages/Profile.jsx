...
const Profile = () => {
    ...
    return (
        <div style={{ height: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
            ...
            {
                user.email === 'admin@gmail.com' ? (<Button variant="contained" color="primary" onClick={() => { navigate('/admin_panel') }}>Admin Panel</Button>) : (<Button variant="contained" color="primary" onClick={() => { window.App.openWhatsapp("+8801771769523", "Name: " + user.fullName + "\nPhone: " + user.phone + "\n\nHello Admin!\nআমার প্যাকেজের মেয়াদ বাড়িয়ে দিন") }}>Admin Whatsapp</Button>) 
            }
