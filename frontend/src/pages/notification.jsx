...
const Notification = () => {
  ...
  return (
    <div style={{ height: '100vh', display: 'flex', width: '100%', textAlign: 'center', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
      <h2 style={{ maxWidth: '70%'}}>আমাদের Apps এ কিছু আপডেট করা হয়েছে সবাই আমাদের নিউ Apps টি ডাউনলোড করে নেন (<a href='https://tmwott.top'>https://tmwott.top</a>) এবং আমাদের Whatsapp গ্রুপ এ এড হয়ে থাকতে পারেন Apps link :    whatsapp  গ্রুপ লিংক : <p><a href='https://chat.whatsapp.com/CnBLGdJ9pEd7qO4f0KzqcO'>https://chat.whatsapp.com/CnBLGdJ9pEd7qO4f0KzqcO</a></p></h2>
      <br/>
